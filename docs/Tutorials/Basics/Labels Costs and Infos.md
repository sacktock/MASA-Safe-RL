...
Runnable notebook: [notebooks/tutorials/02_labels_costs_and_infos.ipynb](https://github.com/sacktockMASA-Safe-RL/blob/main/notebooks/tutorials/02_labels_costs_and_infos.ipynb)
