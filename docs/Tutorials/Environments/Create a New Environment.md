...
Runnable notebook: [notebooks/tutorials/08_create_a_new_environment.ipynb](https://github.com/sacktockMASA-Safe-RL/blob/main/notebooks/tutorials/08_create_a_new_environment.ipynb)
