...
Runnable notebook: [notebooks/tutorials/10_safety_abstractions_pacman_coins.ipynb](https://github.com/sacktockMASA-Safe-RL/blob/main/notebooks/tutorials/10_safety_abstractions_pacman_coins.ipynb)
