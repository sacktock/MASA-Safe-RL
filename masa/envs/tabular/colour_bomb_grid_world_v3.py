...
for i in range(N_COLOURED_ZONES):
    z = i * (GRID_SIZE**2)
    START_STATES += list(np.array([16,199,178,112,26]) + z)
    GREEN_STATES += list(np.array([170]) + z)
    YELLOW_STATES += list(np.array([176,191]) + z)
    RED_STATES += list(np.array([88,89,103,104]) + z)
    BLUE_STATES += list(np.array([121,122,136,137]) + z)
    PINK_STATES += list(np.array([53,54,68,69]) + z)
    WALL_STATES += list(np.array([45,60,75,210,195,180,165,150, 142] + \
